...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row mt-3">
            <div class="col-6">
              <h3 class="bg-success text-center"> Add Upzilla </h3>          
            </div>
        ...
        <div class="row">
          <div class="col-md-6 m-auto">
             <form action="{{ route('upzillas.store')}}" method="POST">
              @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Write Upzilla Name">
                  </div>
                    @error('name')
